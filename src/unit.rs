...
>
{
    ...
    type Mat2: crate::bindings::SimdMatrix2<Scalar = Self::Primitive>;
    /// Either [`glam::Mat3`] or [`glam::DMat3`].
    type Mat3: crate::bindings::SimdMatrix3<Scalar = Self::Primitive>;
    /// Either [`glam::Mat4`] or [`glam::DMat4`].
    type Mat4: crate::bindings::SimdMatrix4<Scalar = Self::Primitive>;
}
